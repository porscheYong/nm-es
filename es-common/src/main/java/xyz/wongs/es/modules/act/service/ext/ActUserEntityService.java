...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new xyz.wongs.es.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new xyz.wongs.es.modules.sys.entity.User(null, userId)))){
