...
<body>
	...
	<form:form id="ModifyStaffInfoForm" modelAttribute="modifyStaffInfo" action="${ctx}/oa/modifyStaffInfo/save" method="post" class="form-horizontal">
		...
		<br>
			<legend>
				<shiro:hasPermission name="oa:modifyStaffInfo:edit">人员信息修改流程${not empty modifyStaffInfo.id?'修改':'申请'}</shiro:hasPermission><shiro:lacksPermission name="oa:modifyStaffInfo:edit">查看</shiro:lacksPermission>
			</legend>
