...
<%--<ul class="nav nav-tabs">--%>
	<%--&lt;%&ndash;<li><a href="${ctx}/oa/testAudit/list">审批列表</a></li>&ndash;%&gt;--%>
	<%--&lt;%&ndash;<li class="active"><a href="#"><shiro:hasPermission name="oa:testAudit:edit">${testAudit.act.procDefId}</shiro:hasPermission><shiro:lacksPermission name="oa:testAudit:edit">查看</shiro:lacksPermission></a></li>&ndash;%&gt;--%>
	<%--<li><a href="#">审批流程</a></li>--%>
<%--</ul>--%>
